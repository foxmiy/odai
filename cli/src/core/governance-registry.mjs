const RUNTIME_RULE_COUPLINGS = [
  {
    ...
    sourceRefs: ["skills/odai/SKILL.md:精神内核", "skills/odai/references/support.md:借力与协作"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/SKILL.md:共同行动边界", "skills/odai/references/dao.md:高影响动作"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/references/craft.md:实施", "skills/odai/references/support.md:状态与记忆"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/references/dao.md:高影响动作"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/SKILL.md:按表现分配支撑", "skills/odai/references/craft.md:实施"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/SKILL.md:按表现分配支撑", "skills/odai/references/dao.md:合作与决定"],
  ...
  },
  {
    ...
    sourceRefs: ["skills/odai/SKILL.md:共同行动边界", "skills/odai/references/support.md:按表现升降"],
  ...
  },
  {
    ...
    sourceRefs: [
      "skills/odai/SKILL.md:共同行动边界",
      "skills/odai/references/dao.md:高影响动作",
    ],
