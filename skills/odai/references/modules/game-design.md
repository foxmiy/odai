...
2. 游戏 UI/UX/UE 优先看 HUD、菜单、背包、商城、编队、养成页、战斗内外界面、引导链路、输入负担、信息密度、可读性和设备适配。
3. 角色 / 场景 / 道具优先看题材定位、形体语言、色彩系统、材质与细节层级、阵营区分、识别性和资产复用。
4. 宣传 / 品牌优先看核心卖点、受众预期、品牌气质、传播场景、活动包装和商店展示一致性。
5. 特效 / 演出优先看战斗反馈、读招清晰度、强弱节奏、镜头配合、性能压力和长时间观看疲劳。
6. 主动补看信息抢焦点、风格漂移、资产复用、宣发与游戏内调性割裂、特效盖住判定、低端机降级和维护成本；未确认前只写待确认、待验证或风险。
7. 需要文档承载时更新同一份 Markdown。终端交付其实是实现时，把视觉口径交回 `道` 接力，不自行横拉实现。
